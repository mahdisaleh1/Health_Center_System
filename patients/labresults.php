...
<head>
    ...
    <title>Lab Results - Health Medical Center</title>
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="lidashboard"><a href="./labresults.php" class="smoothScroll">Lab Results</a></li>
    ...
    <div class="dashcontainer">
        <aside class="sidebar">
            <nav>
                <ul>
                    ...
                    <li class="lidashboard"><a href="./labresults.php">Lab Results</a></li>
        ...
        <main class="content">
            <header>
                <p>Here you can check only tests where results are uploaded!</p>
            </header>
            ...
            <section class="cards">
                ...
                $appointment_query = mysqli_query($con, "
                    ...
                    JOIN labresults ON labtests.test_id = labresults.labtest_id
                    ...
                    WHERE labresults.result_file IS NOT NULL AND appointments.patient_id = '$patient_id'
                    ");
                if (mysqli_num_rows($appointment_query) > 0) {
                    $appointment = mysqli_fetch_assoc($appointment_query);
                    echo "<div class='card'>";
                    echo "<h3> {$appointment['test_name']}</h3>";
                    echo "<p><strong>Doctor Name:</strong>  {$appointment['doctor_name']}</p>";
                    echo "<p class='comment-truncate'><strong>Comments:</strong>  {$appointment['comments']}</p>";
                    echo "<a href='./app_details.php?id={$appointment['appointment_id']}'><button type='button'>View Details</button></a>";
                    echo "</div>";
                } else {
                    echo "<h3>No lab tests with uploaded results available.</h3>";
                }
                ?>
            </section>
        </main>
