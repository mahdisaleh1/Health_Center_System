...
if (isset($_POST['send_dr_message'])) {
    ...
    $stmt->bind_param("iis", $user_id, $doctor_user_id, $message);
    if ($stmt->execute()) {
        echo '<script>alert("Notification has been sent!" );</script>';
        header("Refresh:0.11; url=./notifications.php");
    } else {
...
if (isset($_POST['send_admin_message'])) {
    $sender_id = $_SESSION['user_id'];
    $message = $_POST['adminmessagedetails'];
...
<head>
    ...
    <title>Send Message - Labstaff</title>
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <div class="dashcontainer">
        ...
        <main class="content">
            <header>
                <p>You can send message only for doctors and admin!</p>
            </header>
            ...
            <div class="sendmessage">
                ...
                <div class="sendfordoctor" id="sendfordoctor" style="display: none;">
                    <form action="./sendmessage.php" method="post">
                        <h4>Send Message for a Doctor</h4>
                        <label for="selectdoctor">Select Doctor's Receiver:</label>
                        ...
                        <textarea name="drmessagedetails" placeholder="Write your message here"></textarea>
                        <button type="submit" name="send_dr_message">Send message</button>
                    </form>
                </div>
                <div class="sendforadmin" id="sendforadmin" style="display: none;">
                    <form action="./sendmessage.php" method="post">
                        <h4>Send Message for Admin</h4>
                        <label>Write your message here:</label>
                        <textarea name="adminmessagedetails" placeholder="Write your message here.." required></textarea>
    ...
    <script>
        document.getElementById('selectreceiver').addEventListener('change', function() {
            ...
            const adminDiv = document.getElementById('sendforadmin');
