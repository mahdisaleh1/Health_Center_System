...
<head>
    ...
    <title>Nofitications - Labstaff</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="lidashboard"><a href="./notifications.php" class="smoothScroll">Notifications</a></li>
        ...
        <div class="dashcontainer">
            <aside class="sidebar">
                <nav>
                    <ul>
                        ...
                        <li class="lidashboard"><a href="./notifications.php">Notifications</a></li>
            ...
            <main class="content">
                ...
                <div class="unreadedmsg">
                    <h3>Status: Unread Received Messages</h3>
                    <section class="cards">
                        <?php
                        $query = "
                ...
                <div class="readed_msg">
                    <h3>Status: Read Received Messages</h3>
                    <section class="cards">
                        <?php
                        $query = "
                            SELECT notifications.*, users.username 
