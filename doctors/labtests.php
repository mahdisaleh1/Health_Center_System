...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <div class="dashcontainer">
        ...
        <main class="content">
            <header>
                <a href="./labtests_names.php">
                    <p>CHECK AVAILABLE TESTS</p>
                </a>
            ...
            <div class="second-content">
                <form action="" method="">
                    <h3>Check Tests Appointments</h3><br>
                    <table border="0" id="myTable" class="table table-stripped">
                        ...
                        <tbody id="tableBody">
                            ...
                            WHERE appointments.doctor_id = $doctor_id AND type = 'test'
                        ";
                            $result = mysqli_query($con, $query);

                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>
                                    <th><a <a class='userdetails' href='./app_details.php?id={$row['appointment_id']}'>><i class='fa fa-plus'></i></a></th>
                                    <th>{$row['labtest_id']}</th>
                                    <td>{$row['fullname']}</td>
