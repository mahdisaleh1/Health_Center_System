...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="lidashboard"><a href="./doctorprofile.php" class="smoothScroll">Profile</a></li>
    ...
    <div class="dashcontainer">
        <aside class="sidebar">
            <nav>
                <ul>
                    ...
                    <li class="lidashboard"><a href="./doctorprofile.php">Profile</a></li>
        ...
        <main class="content">
            <header>
                <p>If you want to update your work information, please check with your admin! (Time, date available,..)</p>
            </header>
