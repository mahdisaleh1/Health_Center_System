...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <div class="dashcontainer">
        ...
        <main class="content">
            <header>
                <a href="./add_prescriptions.php">
                    <p>Click here to add new prescription!</p>
                </a>
                    ...
                    <table border="0" id="myTable" class="table table-stripped">
                        ...
                        ";
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>
                                    <th><a <a class='userdetails' href='./presc_details.php?id={$row['pres_id']}'>><i class='fa fa-plus'></i></a></th>
                                    <th>{$row['pres_id']}</th>
                                    <td>{$row['fullname']}</td>
                                    <td>{$row['diagnosis']}</td>
    ...
    <script>
        ...
        document.getElementById("searchinp").addEventListener("keyup", function() {
            ...
            fetch("./functionality/search_prescription.php", {
                    method: "POST",
                    headers: {
