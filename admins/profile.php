...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="lidashboard"><a href="./profile.php" class="smoothScroll">Profile</a></li>
    ...
    <div class="dashcontainer">
        <aside class="sidebar">
            <nav>
                <ul>
                    ...
                    <li class="lidashboard"><a href="./profile.php">Profile</a></li>
        ...
        <main class="content">
            <header>
                <p>In this page, you can see and modify your account info!</p>
            </header>
